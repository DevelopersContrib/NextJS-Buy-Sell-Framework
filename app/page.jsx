        ...
        <div className="container tw-relative tw-px-4">
          <div className="row tw-mb-8">
            <div className="col-xl-12 tw-text-center">
              ...
              <p className="tw-text-lg tw-font-light tw-mt-4">Proud Member of CONTRIB | Powered by VNOC</p>
            </div>
          </div>
          <div className="row gy-3 gx-md-3">
            <div className="col-xl-4">
              <div className="tw-bg-gray-800 tw-p-8 tw-text-center tw-rounded-md tw-text-white tw-shadow-md tw-transition-transform tw-transform hover:tw-scale-105">
                ...
                <div className="mb-3 d-grid">
                  <Link href="/buy" className="btn btn-primary btn-lg tw-transition-colors hover:tw-bg-blue-700"> Make An Offer </Link>
                </div>
            ...
            <div className="col-xl-4">
              <div className="tw-bg-gray-800 tw-p-8 tw-text-center tw-rounded-md tw-text-white tw-shadow-md tw-transition-transform tw-transform hover:tw-scale-105">
                ...
                <div className="mb-3 d-grid">
                  <Link href="/partner" className="btn btn-primary btn-lg tw-transition-colors hover:tw-bg-blue-700"> Submit Partnership </Link>
                </div>
            ...
            <div className="col-xl-4">
              <div className="tw-bg-gray-800 tw-p-8 tw-text-center tw-rounded-md tw-text-white tw-shadow-md tw-transition-transform tw-transform hover:tw-scale-105">
                ...
                <div className="mb-3 d-grid">
                  <a target="_blank" href={"https://www.contrib.com/signup/firststep?domain="+domain} className="btn btn-primary btn-lg tw-transition-colors hover:tw-bg-blue-700"> Join Now </a>
                </div>
