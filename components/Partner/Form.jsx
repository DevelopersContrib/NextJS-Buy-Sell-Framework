      ...
      if (data.step === 1) {
        dataErrors = {
          ...
          passwordError:
            ...
            (data.password.length < 6 ? "Password has less than 5 characters." : ""),
          cpasswordError:
            (data.cpassword ? "" : "Confirm password is required.") ||
            (data.password !== data.cpassword ? "Confirm password did not match." : ""),
          messageError: data.message ? "" : "Message is required.",
        };
      } else if (data.step === 2) {
        dataErrors = {
          websiteError:
            (data.website ? "" : "Website is required.") ||
